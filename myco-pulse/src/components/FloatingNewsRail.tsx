                ...
                >
                  {isActive ? (
                    <div className="h-full w-full flex flex-col overflow-hidden">
                      <div className="w-full shrink-0 bg-white border-l-[5px] border-l-[#0055cc] pl-2.5 pr-2.5 py-2 shadow-[0_6px_20px_rgba(0,0,0,0.4)] rounded-t-sm">
                        <p className="text-[9px] font-black uppercase tracking-[0.16em] text-[#0055cc] mb-0.5 leading-tight line-clamp-1">
                          {line.label}
                        </p>
                        <p className="text-[10px] font-black uppercase leading-[1.28] text-black line-clamp-3 [overflow-wrap:anywhere]">
                          {line.headline}
                        </p>
                      </div>
                    ...
                    <p className="h-full w-full flex items-center text-[9px] font-bold uppercase tracking-wide leading-[1.3] py-0.5 line-clamp-2 [text-shadow:0_1px_4px_rgba(0,0,0,0.9)] [overflow-wrap:anywhere]">
                      <span className="text-[#8ec8ff]/90 shrink-0">{line.label}:</span>{" "}
                      <span className="text-white/55 min-w-0">{line.headline}</span>
                    </p>
                  )}
                </motion.div>
              );
